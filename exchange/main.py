...
def CombinationItem(item1, item2):
    ...
    print( '展开后原式=', ConbinePoly)



# 判断展开函数
def ExpansionPoly(Poly = None, exfu=None):
    global ConbinePoly
    Poly = copy.deepcopy(ConbinePoly)
    # 删除空元素
    removeEmpty()
...
def insertList(List_, entry_, j, List = None, entry = None):
